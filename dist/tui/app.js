...
export function MessageBlock({ message, theme, maxLines }) {
    ...
    return _jsxs(Box, { flexDirection: "column", marginBottom: 1, children: [_jsx(Text, { bold: true, color: color, children: role }), lines.map((line, index) => {
            ...
            }), overflow > 0 && _jsxs(Text, { color: theme.muted, children: ["\u2026", overflow, " more line(s) \u2014 Ctrl+Y for the full untruncated conversation"] })] });
}
/**
